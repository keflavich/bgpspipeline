...
;fail distmap,[getenv('SLICED_POLY')+'/neptune/050626_o19_raw_ds5.nc',getenv('SLICED_POLY')+'/neptune/050626_o20_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/neptune_050626_o19-20',doplot=doplot,outtxt=outtxt
...
distmap,[getenv('SLICED')+'/3c279/050703_ob1_raw_ds5.nc',getenv('SLICED')+'/3c279/050703_ob2_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/3c279_050703_ob1-2',doplot=doplot,outtxt=outtxt

distmap,[getenv('SLICED_POLY')+'/mars/050911_o22_raw_ds5.nc',getenv('SLICED_POLY')+'/mars/050911_o23_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/mars_050911_o22-3',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap,[getenv('SLICED_POLY')+'/uranus/050904_o31_raw_ds5.nc',getenv('SLICED_POLY')+'/uranus/050904_o32_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/uranus_050904_o31-2',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale,npca=13
;distmap,[getenv('SLICED_POLY')+'/uranus/050905_ob6_raw_ds5.nc',getenv('SLICED_POLY')+'/uranus/050905_ob7_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/uranus_050905_ob6-7',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale,npca=13
...
; bad data distmap,[getenv('SLICED')+'/3c345/060607_ob6_raw_ds5.nc',getenv('SLICED')+'/3c345/060607_ob7_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/3c345_060607_ob6-7',doplot=doplot,outtxt=outtxt
...
distmap,getenv('SLICED')+'/uranus/060905_ob6_raw_ds5.nc',getenv('WORKINGDIR')+'/distmaps/uranus_060905_ob6',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap,getenv('SLICED')+'/1923p210/060904_o14_raw_ds5.nc',getenv('WORKINGDIR')+'/distmaps/1923p210_060904_o14',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap,getenv('SLICED')+'/uranus/060906_o12_raw_ds5.nc',getenv('WORKINGDIR')+'/distmaps/uranus_060906_o12',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
...
distmap,getenv('SLICED')+'/uranus/070629_ob8_raw_ds5.nc',getenv('WORKINGDIR')+'/distmaps/uranus_070629_ob8',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale

distmap,[getenv('SLICED_POLY')+'/g34.3/070630_o34_raw_ds1.nc',getenv('SLICED_POLY')+'/g34.3/070630_o35_raw_ds1.nc'],getenv('WORKINGDIR')+'/distmaps/g34.3_070630_o34-5',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap,[getenv('SLICED_POLY')+'/uranus/070701_o38_raw_ds1.nc',getenv('SLICED_POLY')+'/uranus/070701_o39_raw_ds1.nc'],getenv('WORKINGDIR')+'/distmaps/uranus_070701_o38-9',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap,[getenv('SLICED_POLY')+'/uranus/070702_o41_raw_ds1.nc',getenv('SLICED_POLY')+'/uranus/070702_o42_raw_ds1.nc'],getenv('WORKINGDIR')+'/distmaps/uranus_070702_o41-2',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
...
distmap,[getenv('SLICED')+'/mars/070913_o22_raw_ds5.nc',getenv('SLICED')+'/mars/070913_o23_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/mars_070913_o22-3',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale,/mars
distmap,[getenv('SLICED')+'/neptune/070902_ob5_raw_ds5.nc',getenv('SLICED')+'/neptune/070902_ob6_raw_ds5.nc'],getenv('WORKINGDIR')+'/distmaps/neptune_070902_ob5-6',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
