...
result[*,0] = X[*,0] * (A[0]*cos(A[5])+A[4]*sin(A[5])) * cos(X[*,1] + A[3])
result[*,1] = X[*,0] * (A[4]*cos(A[5])+A[0]*sin(A[5])) * sin(X[*,1] + A[3])
