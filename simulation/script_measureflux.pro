...
measure_flux,path+'v1.0.2_l111_13pca_deconv_14.4_sim_sim_sources.sav',path+'v1.0.2_l111_13pca_deconv_14.4_sim_map20.fits',path+'v1.0.2_l111_13pca_deconv_14.4_sim_initial.fits',/doplot,xtitle="!6Object size (arcsec)",ytitle="!6Fraction of flux recovered",charsize=1.5,charthick=2,xthick=2,ythick=2,thick=3,xax=xax1,yax=yax1
...
measure_flux,path+'v1.0.2_l111_13pca_deconv_7.2_sim_sim_sources.sav',path+'v1.0.2_l111_13pca_deconv_7.2_sim_map20.fits',path+'v1.0.2_l111_13pca_deconv_7.2_sim_initial.fits',/doplot,/overplot,color=100,thick=3,xax=xax4,yax=yax4
legend,['7.2"','14.4"','21.6"','31.2"'],psym=[1,1,1,1],color=[100,0,250,150],/right,charsize=1.5,charthick=2,thick=3 ;,/right
device,/close_file
...
measure_flux,path+'v1.0.2_l111_26pca_deconv_sim_sim_sources.sav',path+'v1.0.2_l111_26pca_deconv_sim_map20.fits',path+'v1.0.2_l111_26pca_deconv_sim_initial.fits',/doplot,/overplot,color=175,thick=3,xax=xax8,yax=yax8
measure_flux,path+'v1.0.2_l111_21pca_deconv_sim_sim_sources.sav',path+'v1.0.2_l111_21pca_deconv_sim_map20.fits',path+'v1.0.2_l111_21pca_deconv_sim_initial.fits',/doplot,/overplot,color=125,thick=3,xax=xax7,yax=yax7
...
measure_flux,path+'v1.0.2_l111_13pca_deconv_14.4_sim_sim_sources.sav',path+'v1.0.2_l111_13pca_deconv_14.4_sim_map20.fits',path+'v1.0.2_l111_13pca_deconv_14.4_sim_initial.fits',/doplot,/overplot,color=225,thick=3,xax=xax3,yax=yax3
...
plot,xax1,yax1,xtitle="!6Object size (arcsec)",ytitle="!6Fraction of flux recovered",charsize=1.5,charthick=2,xthick=2,ythick=2,thick=3
oplot,xax2,yax2,thick=3,color=250
oplot,xax3,yax3,thick=3,color=225
oplot,xax4,yax4,thick=3,color=200
oplot,xax5,yax5,thick=3,color=150
oplot,xax6,yax6,thick=3,color=50
oplot,xax7,yax7,thick=3,color=125
oplot,xax8,yax8,thick=3,color=175
device,/close_file
