...
astronomical sky on a limited range of angular scales and produce artifacts in
...
the passband.  \citet{nummelin1998} found that 22\% of the flux density in one
...
\citep[][hereafter SLC]{difrancesco08}.  These maps provide an excellent cross-check on the
...
rather makes use of all the information available.  The
...
Figure \ref{fig:deconv_filter}b shows the fraction of flux recovered in the
