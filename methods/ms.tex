...
well-separated Gaussian sources with FWHM as indicated.
...
The $>$100\% recovery for simulated sources smaller than the deconvolution kernel is a
side-effect; since the deconvolution kernel is smaller than the beam, no real
astrophysical source should ever be smaller than the kernel.
\emph{Right}:
...
\Figure{aper_phot_hpf_beam}{[James - figure needs clarification] The effect of performing aperture
