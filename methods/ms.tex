...
\Figure{flagger_withglitch}{An illustration of the flagging process
using the waterfall plot. The glitch apparent at middle right is the
same one whose time series is shown in Figure
\ref{fig:CosmicRayGlitch}.  Because of the PCA subtraction, the effect
of the glitch also propagates over the other bolometers, appearing as
a horizontal stripe.}  {fig:Flag1}{1.0}
