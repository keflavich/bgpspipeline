...
pro process_file_list,filelist,array_params=array_params,bolo_params=bolo_params,beam_locations=beam_locations,$
    ...
    for i=0,n_e(thefiles)-1 do begin
        ...
        case date of 
            ...
            '0709': begin
;                array_params     = '/bgps_params/array_params_sep07_no_rot.txt'
        ...
        if stregex(infile,'_ds5.nc') gt 0 then begin
            if file_test(infile) then begin 
                ...
                calcoeffs_to_ncdf,infile,[-0.00333379,-2.92617,6.97269]
            endif else begin
            ...
            calcoeffs_to_ncdf,outfile,[-0.00333379,-2.92617,6.97269]
        endelse
    endfor
    retall
end
