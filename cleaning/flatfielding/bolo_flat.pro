...
function bolo_flat,timestream,scan_model=scan_model,scale_coeffs=scale_coeffs,scale_ts=scale_ts,_extra=extra
        ...
        scan_average = median(timestream,dimension=1) ; scanlength array that is the median over bolometers
        ...
        scale_coeffs  /= median(scale_coeffs)                         ; somehow the scale coeffs don't always come out to flat. ????
