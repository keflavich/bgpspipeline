...
;                 when reading a bzip or Unix compress file.     Note that 
;                 automatic byteswapping cannnot be set for a Unix pipe, since
;                 the SWAP_IF_LITTLE_ENDIAN keyword is only available for the
;                 OPEN command.
; SIDE EFFECTS:
