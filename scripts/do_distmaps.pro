...
if file_test(getenv('SLICED')+'/neptune/060602_o30_raw_ds5.nc') then distmap_comp,getenv('SLICED')+'/neptune/060602_o30_raw_ds5.nc',getenv('workingdir')+'/distmaps/neptune_060602_o30',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap_comp,getenv('SLICED')+'/neptune/060602_o31_raw_ds5.nc',getenv('workingdir')+'/distmaps/neptune_060602_o31',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap_comp,getenv('SLICED_POLY')+'/mars/060605_ob1_raw_ds1.nc',getenv('workingdir')+'/distmaps/mars_060605_ob1',/mars,doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap_comp,getenv('SLICED_POLY')+'/mars/060605_ob2_raw_ds1.nc',getenv('workingdir')+'/distmaps/mars_060605_ob2',/mars,doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
if file_test(getenv('SLICED')+'/uranus/060621_o29_raw_ds5.nc') then distmap_comp,getenv('SLICED')+'/uranus/060621_o29_raw_ds5.nc',getenv('workingdir')+'/distmaps/uranus_060621_o29',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
if file_test(getenv('SLICED')+'/uranus/060621_o30_raw_ds5.nc') then distmap_comp,getenv('SLICED')+'/uranus/060621_o30_raw_ds5.nc',getenv('workingdir')+'/distmaps/uranus_060621_o30',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
...
distmap_comp,getenv('SLICED_POLY')+'/g34.3/070630_o34_raw_ds1.nc',getenv('workingdir')+'/distmaps/g34.3_070630_o34',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap_comp,getenv('SLICED_POLY')+'/g34.3/070630_o35_raw_ds1.nc',getenv('workingdir')+'/distmaps/g34.3_070630_o35',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap_comp,getenv('SLICED_POLY')+'/uranus/070702_o42_raw_ds1.nc',getenv('workingdir')+'/distmaps/uranus_070702_o42',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
...
distmap_comp,getenv('SLICED_POLY')+'/uranus/070702_o41_raw_ds1.nc',getenv('workingdir')+'/distmaps/uranus_070702_o41',doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
...
distmap_comp,getenv('SLICED')+'/mars/070913_o22_raw_ds5.nc',getenv('workingdir')+'/distmaps/mars_070913_o22',/mars,doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
distmap_comp,getenv('SLICED')+'/mars/070913_o23_raw_ds5.nc',getenv('workingdir')+'/distmaps/mars_070913_o23',/mars,doplot=doplot,fixgrid=fixgrid,fixscale=fixscale
