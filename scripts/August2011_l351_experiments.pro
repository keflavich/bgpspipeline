...
coalign_field,'l351','070725_ob3',premap=1,coalign=1,deconvolve=1,prefix='v1.0.2_ds5_oldcal_',dsfactor=5,niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_infile.txt",refim=getenv('REFDIR')+'/v0.6.2_l351_13pca_map09.fits',/pointing_model,mvperjy = [-0.00333379,-2.92617,6.97269]
coalign_field,'l351','070725_ob3',premap=1,coalign=1,deconvolve=1,prefix='v1.0.2_ds5_v1cal_',dsfactor=5,niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_infile.txt",refim=getenv('REFDIR')+'/v0.6.2_l351_13pca_map09.fits',/pointing_model,mvperjy = [ -3.26472e-15,0.398740,3.32002]
coalign_field,'l351','070725_ob3',premap=1,coalign=1,deconvolve=1,prefix='v1.0.2_ds5_v2cal_',dsfactor=5,niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_infile.txt",refim=getenv('REFDIR')+'/v0.6.2_l351_13pca_map09.fits',/pointing_model,mvperjy = [0.0,0.773362,4.56406]
;coalign_field,'l351','070725_ob3',premap=1,deconvolve=1,prefix='v1.0.2_ds5_original',niter=replicate(13,51),fits_out=[0,1,20,50],dosave=2,infile="l351_infile.txt",refim='/Volumes/disk2/ref_fields/v0.6.2_l351_13pca_map09.fits',mvperjy=[ -3.26472e-15,0.398740,3.32002],/pointing_model
...
coalign_field,'l351','reference_v1',premap=1,coalign=1,deconvolve=1,prefix='v1.0.2_ds2_',dsfactor=2,niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_ds2_infile.txt",refim='/Volumes/disk2/data/bgps/releases/IPAC/map/v1.0.2_l351_13pca_map50_crop.fits',/pointing_model,indiv_prefix='indiv_v1.0.2'
coalign_field,'l351','reference_v1',premap=1,coalign=1,deconvolve=1,prefix='v1.0.2_ds5_',dsfactor=5,niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_ds5_infile.txt",refim='/Volumes/disk2/data/bgps/releases/IPAC/map/v1.0.2_l351_13pca_map50_crop.fits',/pointing_model,indiv_prefix='indiv_v1.0.2'
...
compare_images,emptyplaceholder,prefix2=l351dir+v1ds2fn,prefix1=l351dir+v1ds5fn,suffix2="_map20.fits",suffix1="_map20.fits",$
