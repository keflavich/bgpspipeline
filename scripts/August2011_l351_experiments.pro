...
coalign_field,'l351','reference_v1',premap=0,coalign=0,deconvolve=1,prefix='v1.0.2_ds2_',dsfactor=2,niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_ds2_infile.txt",refim=getenv('REFDIR')+'/l351_ref.fits',/pointing_model
...
coalign_field,'l351','070725_ob3',premap=0,deconvolve=1,prefix='v1.0.2_ds5_original',niter=replicate(13,51),fits_out=[0,1,20,50],dosave=0,infile="l351_infile.txt",refim='/Volumes/disk2/ref_fields/v0.6.2_l351_13pca_map09.fits',mvperjy=[ -3.26472e-15,0.398740,3.32002],/pointing_model
