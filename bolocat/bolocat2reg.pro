...
;               this conversion factor
    ...
    for i=0,n_e(bgps.filename)-1 do begin
        ...
        printf,outf,bgps[i].glon,bgps[i].glat,bgps[i].mommajpix*asperpix,bgps[i].momminpix*asperpix,bgps[i].posang/!dtor,$
              format='("ellipse(",F10.6,1H,,F10.6,1H,,F9.5,2H",,F9.5,2H",,F8.4,1H))'
