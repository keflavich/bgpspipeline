...
; file_arg is assumed to be a list of filenames
; params_file is assumed to be a single bolo_params file
; global_array_params_file is also a single array_params file
; ncfile is a list of ncdf filenames
...
n_files = n_e(file_arg)

;---------------------------------------------------------------------------
;
; Next, we need to make sure all the input/output files exist/can be written.
; Then read in the data.
;    NO WE DONT just CRASH if it doesn't work that's what'll happen anyway.
;----------------------------------------------------------------------------
